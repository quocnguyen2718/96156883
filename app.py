...
def register():
    ...
    if request.method == "POST":
        ...
        if not username:
            return apology(message="Please enter a username")
        if len(check_repeat_username) != 0:
            return apology(message="Sorry this username is already taken")
        if not password:
            return apology(message="Please enter a password")
